...
const JILLIE_LETTERS = [
    ['Hey Jillie,','','You make everything better. The good days,','the hard days, the boring ones in between.','I don\'t say it enough but I think about','how lucky I am pretty much all the time.','','I love you.'],
    ['Jillie,','','I fall for you a little more every single','day and I didn\'t even know that was possible.','You are the best thing that ever happened to me','and I will never stop telling you that.'],
    ['Hey you,','','I hope you know that you\'re my favorite','person in the world. Not close. Not even','a competition. Just you. Always you.'],
    ['Jillie,','','Some people search their whole life for','what I found in you. I don\'t take that','for granted. Not for a single second.','','You\'re my person.'],
    ['Hey Jillie,','','I love the way you laugh when something','catches you off guard. I love how you care','about people so deeply it\'s almost unfair.','I love that you chose me.','','I\'ll keep choosing you back. Every time.'],
    ['Jillie,','','The distance is hard sometimes. But then','I hear your voice and none of it matters.','You\'re worth every mile. Every minute.','Every single second of waiting.'],
    ['Hey,','','You walked into my life and made it','something I actually look forward to.','I didn\'t know it could feel like this.','Thank you for showing me.','','I love you so much.'],
    ['Jillie,','','When everything feels heavy, you make','it feel light again. You don\'t even have','to try. You just do. That\'s who you are.','','And I\'m so grateful you\'re mine.'],
    ['Hey Jillie,','','I want you to know something. No matter','how crazy life gets, no matter how far','apart we are on any given day, you are','the first thing I think about when I','wake up and the last thing before I sleep.'],
    ['Jillie,','','I don\'t need a perfect life. I just need','you in it. That\'s the whole list. That\'s','everything. Just you.'],
    ['Hey you,','','I know I\'m not always great with words.','But what I feel for you is the most real','thing I\'ve ever known. You make me want','to be better. You make me believe I can be.','','I love you more than I know how to say.'],
    ['Jillie,','','You are so much stronger than you give','yourself credit for. I watch you handle','everything life throws at you and I\'m','just in awe. Every single time.','','I\'m so proud of you.'],
    ['Hey Jillie,','','There are a million things I could say','but they all come back to the same thing.','I love you. Simply. Completely. Without','any conditions. Just love.'],
    ['Jillie,','','You know what I love most? That we can','be ourselves with each other. No act.','No pretending. Just us. That\'s rare.','That\'s everything.'],
    ['Hey,','','Some days I still can\'t believe you\'re','real. That someone this kind, this funny,','this beautiful actually exists. And then','you call me and I remember. Yeah. She\'s real.','And she\'s mine.'],
    ['Jillie,','','I would rather have a hard day with you','than a perfect day without you. That\'s','how I know this is it. You\'re it.'],
    ['Hey Jillie,','','Loving you is the easiest thing I\'ve','ever done. Everything else takes effort.','But this? This just makes sense.'],
    ['Jillie,','','I think about our future all the time.','Not in a stressful way. In a way that','makes me smile. Because any future with','you in it is one I want.'],
    ['Hey you,','','I don\'t need you to be perfect. I just','need you to be you. Because the real you','is the person I fell in love with and I','fall a little harder every day.'],
    ['Jillie,','','You are home to me. Not a place. Not','a city. You. Wherever you are is where','I want to be. It\'s that simple.','','I love you endlessly.'],
    ['Hey Jillie,','','I never knew what it meant to miss','someone until you. The quiet hits','different when you\'re not around.','','Come back soon.'],
    ['Jillie,','','You have this way of making me feel','like the only person in the room. Even','when the room is full. Even over the','phone. I don\'t know how you do it.'],
    ['Hey,','','I wrote this for no reason other than','I was thinking about you. Which is most','of the time if I\'m being honest.'],
    ['Jillie,','','You deserve the world and I\'m going','to spend my life trying to give it to','you. Not because I have to. Because','there\'s nothing I\'d rather do.'],
    ['Hey Jillie,','','Thank you for being patient with me.','Thank you for believing in me even when','I don\'t believe in myself. Thank you for','loving me the way you do.','','I don\'t deserve you but I\'m keeping you.'],
    ['Jillie,','','My favorite sound in the world is your','laugh. My favorite sight is your smile.','My favorite feeling is when you\'re next','to me. Everything else is just noise.'],
    ['Hey you,','','I could be having the worst day and','one text from you fixes it. You have','no idea the power you have over me.','Actually you probably do.'],
    ['Jillie,','','Every love song makes sense now.','Every cheesy movie. Every poem I used','to roll my eyes at. I get it now.','It was all about this.'],
    ['Hey Jillie,','','I\'m not scared of much. But the thought','of a life without you in it is the one','thing I never want to face. You\'re my','whole heart. All of it.'],
    ['Jillie,','','You make me laugh harder than anyone.','You make me think deeper than anyone.','You make me love bigger than I ever','thought I could. You\'re my everything.'],
    ['Hey,','','There\'s a version of me before you and','a version of me after. The after version','is better in every way. That\'s because','of you. All you.'],
    ['Jillie,','','When I picture growing old, you\'re','always there. Gray hair. Coffee on the','porch. Still making me laugh. Still','the most beautiful girl I\'ve ever seen.'],
    ['Hey Jillie,','','I love you in the morning when you\'re','half asleep. I love you at night when','you can barely keep your eyes open.','I love you in every single moment','in between. Always.'],
    ['Jillie,','','You didn\'t just give me love. You gave','me a best friend. A teammate. Someone','who actually gets me. I hit the jackpot','and I know it.'],
    ['Hey you,','','If I could go back and relive any moment','in my life, I\'d pick the one where I met','you. And then every moment after that.'],
    ['Jillie,','','I\'m writing this with a big stupid smile','on my face because that\'s what happens','when I think about you. Every time.','Without fail.'],
    ['Hey Jillie,','','No matter where life takes us, no matter','what changes, this won\'t. What I feel for','you is permanent. It\'s carved in stone.','It\'s not going anywhere.','','And neither am I.'],
    ['Jillie,','','You are the calm in every storm I\'ve','ever been through. The steady hand.','The soft voice. The safe place. I hope','I give you even half of what you give me.'],
    ['Hey,','','Sometimes I catch myself staring at you','and I have to look away before you notice.','But honestly? I hope you do notice.','I want you to know.'],
    ['Jillie,','','I love the little things. The way you','scrunch your nose. The way you say my','name. The way you hold my hand a little','tighter when we\'re about to say goodbye.','','I notice all of it.'],
    ['Hey Jillie,','','You could have anyone. And you picked','me. I will spend the rest of my life','making sure you never regret that.'],
    ['Jillie,','','I used to think love was complicated.','Then I met you and realized it\'s the','simplest thing in the world when it\'s','with the right person.'],
    ['Hey,','','You know that feeling when you\'re driving','and your favorite song comes on? That\'s','what it feels like every time I see you.','Every single time.'],
    ['Jillie,','','The best part of my day is hearing from','you. Doesn\'t matter what you say. Could','be anything. Just knowing you\'re there','is enough.'],
    ['Hey Jillie,','','I want to build a life with you. A real','one. Messy and imperfect and completely','ours. I want all of it. The good parts','and the hard parts. All of it with you.'],
    ['Jillie,','','If someone asked me what I\'m most proud','of, it wouldn\'t be school or volleyball','or anything like that. It would be that','I get to call you mine.'],
    ['Hey you,','','You teach me something new about love','every day. How to be softer. How to','listen better. How to show up even when','it\'s hard. You make me a better man.'],
    ['Jillie,','','There is no one else. There never will','be. You ruined everyone else for me the','day we met and I wouldn\'t change a thing.'],
    ['Hey Jillie,','','I keep every good morning text. Every','goodnight. Every random thought you send','me in the middle of the day. They all','matter. You have no idea how much.'],
    ['Jillie,','','I\'d drive a thousand miles just to see','you for five minutes. And it would still','be worth it. That\'s not an exaggeration.','That\'s just how it is.'],
    ['Hey,','','You are the reason I believe in something','bigger than myself. Whatever this is,','whatever brought us together, I\'m','thankful for it every single day.'],
    ['Jillie,','','You look at me like I\'m enough. Like','I don\'t have to prove anything. Like I','can just be me. Do you know how rare','that is? Do you know what that means to me?'],
    ['Hey Jillie,','','I fell in love with your heart first.','Then your laugh. Then your stubborness.','Then everything else. I never stood a','chance and I\'m glad I didn\'t.'],
    ['Jillie,','','When I\'m old and someone asks me what','the best years of my life were, I\'ll','say the ones with you. Every single one.'],
    ['Hey you,','','Nothing in this world makes sense the','way you do. You are my favorite thing','about being alive and I mean that.'],
    ['Jillie,','','I pray for you. For us. For the life','we\'re building. I pray that I never take','a single moment with you for granted.','So far so good.'],
    ['Hey Jillie,','','Your voice is my favorite sound. Your','arms are my favorite place. Your heart','is my favorite home. I love everything','about you and everything you are.'],
    ['Jillie,','','I don\'t just love you for who you are.','I love who I am when I\'m with you.','You bring out the best in me and make','me want to earn it every day.'],
    ['Hey,','','I just want you to know that no matter','how long we\'ve been together, I will','never stop trying to make you smile.','That\'s a promise.'],
    ['Jillie,','','You are the plot twist I never saw','coming. The best kind. The kind that','changes everything and makes the whole','story make sense.'],
    ['Hey Jillie,','','Some people find love and hold it','loosely. I\'m holding onto you with','everything I have. Not because I\'m','scared to lose you. Because I know','exactly what I have.'],
    ['Jillie,','','If I had to choose between breathing','and loving you, I\'d use my last breath','to tell you I love you. That\'s dramatic.','But it\'s true.'],
    ['Hey you,','','I don\'t know what I did to deserve you','but I\'m not questioning it. I\'m just','grateful. Every morning. Every night.','Every moment in between.'],
    ['Jillie,','','The world is big and loud and crazy.','But when I\'m with you it gets real quiet.','Real still. Like nothing else matters.','Because it doesn\'t.'],
    ['Hey Jillie,','','I love the way your eyes light up when','you talk about something you care about.','I could listen to you talk for hours','and never get tired of it.'],
    ['Jillie,','','I\'m not a poet. I\'m not a songwriter.','I\'m just a guy who loves a girl more','than he knows how to explain. But I\'ll','keep trying for the rest of my life.'],
    ['Hey,','','Three words will never be enough to tell','you what you mean to me. But I\'ll say','them anyway. Every day. Forever.','','I love you.'],
    ['Jillie,','','You are my peace. My excitement. My','comfort. My adventure. You are every','good thing rolled into one person and','I still can\'t believe you\'re real.'],
    ['Hey Jillie,','','The day I met you, everything clicked.','Like the universe said here you go, this','is what you\'ve been waiting for. And it','was right.'],
    ['Jillie,','','I want lazy Sundays with you. Road trips','with you. Grocery runs with you. The big','moments and the small ones. I want the','whole thing. With you.'],
    ['Hey you,','','You are proof that good things happen','to people who wait. I\'d wait for you','all over again. A hundred times over.','Without a second thought.'],
    ['Jillie,','','Falling in love with you wasn\'t a choice.','Staying in love with you isn\'t either.','It\'s just what happens when you find','someone who fits you this perfectly.'],
    ['Hey Jillie,','','I love you on the easy days. I love you','on the hard days. I love you on the days','when nothing happens at all. There is no','version of any day where I don\'t love you.'],
    ['Jillie,','','I think the universe knew what it was','doing when it put us together. I really','do. This wasn\'t an accident. This was','always supposed to happen.'],
    ['Hey,','','You are the first person I want to tell','good news to. The first person I want','when things go wrong. The first person.','Always. In everything.'],
    ['Jillie,','','There are 8 billion people on this planet','and I found you. If that\'s not proof that','something out there is looking out for me','then I don\'t know what is.'],
    ['Hey Jillie,','','I\'m yours. Completely. Not halfway. Not','sometimes. Not when it\'s convenient. All','the way. Every day. No matter what.'],
    ['Jillie,','','Some things in life you just know. Like','how the sun will rise tomorrow. Like how','water is wet. Like how I will love you','for the rest of my life. Some things','you just know.'],
    ['Hey you,','','You are the answer to a prayer I didn\'t','even know I was praying. The best kind','of surprise. The kind that lasts forever.'],
    ['Jillie,','','I love you. Not the way people say it','when they\'re half paying attention. I','mean it from the deepest part of who I','am. With everything. Always.'],
    ['Hey Jillie,','','If love is a journey then you\'re my','favorite destination. My favorite road.','My favorite everything. I\'d take the','long way every time if it meant more','time with you.'],
];

// Shuffle-bag so letters never repeat until all 80 are shown
const _letterBag = { order: [], pos: 0 };
function _nextLetter() {
    if (_letterBag.pos >= _letterBag.order.length) {
        _letterBag.order = JILLIE_LETTERS.map((_, i) => i);
        for (let i = _letterBag.order.length - 1; i > 0; i--) {
            const j = Math.floor(Math.random() * (i + 1));
            [_letterBag.order[i], _letterBag.order[j]] = [_letterBag.order[j], _letterBag.order[i]];
        }
        _letterBag.pos = 0;
    }
    return JILLIE_LETTERS[_letterBag.order[_letterBag.pos++]];
}
...
function processCommand(cmd, menuData) {
    ...
    if (c === 'jillian' || c === 'jillie') {
        const letter = _nextLetter();
        return [
            { text: '' },
            { text: '-----------------------------------------------', color: '#f9a8d4' },
            { text: '' },
