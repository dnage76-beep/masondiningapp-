    ...
    if (c === 'jillian' || c === 'jillie') {
        const letters = [
            ...
            [
                'Hey Jillie,',
                '',
                'I never knew what it meant to miss',
                'someone until you. The quiet hits',
                'different when you\'re not around.',
                '',
                'Come back soon.',
            ],
            [
                'Jillie,',
                '',
                'You have this way of making me feel',
                'like the only person in the room. Even',
                'when the room is full. Even over the',
                'phone. I don\'t know how you do it.',
            ],
            [
                'Hey,',
                '',
                'I wrote this for no reason other than',
                'I was thinking about you. Which is most',
                'of the time if I\'m being honest.',
            ],
            [
                'Jillie,',
                '',
                'You deserve the world and I\'m going',
                'to spend my life trying to give it to',
                'you. Not because I have to. Because',
            ...
            [
                ...
                'I don\'t believe in myself. Thank you for',
            ...
            [
                'Jillie,',
                '',
                'My favorite sound in the world is your',
                'laugh. My favorite sight is your smile.',
                'My favorite feeling is when you\'re next',
                'to me. Everything else is just noise.',
            ],
            [
                'Hey you,',
                '',
                'I could be having the worst day and',
                'one text from you fixes it. You have',
                'no idea the power you have over me.',
            ...
            [
                ...
                'Every cheesy movie. Every poem I used',
                'to roll my eyes at. I get it now.',
                'It was all about this.',
            ],
            [
                'Hey Jillie,',
                '',
                'I\'m not scared of much. But the thought',
                'of a life without you in it is the one',
                'thing I never want to face. You\'re my',
                'whole heart. All of it.',
            ],
            [
                'Jillie,',
                '',
                'You make me laugh harder than anyone.',
                'You make me think deeper than anyone.',
                'You make me love bigger than I ever',
                'thought I could. You\'re my everything.',
            ],
            [
                'Hey,',
                '',
                'There\'s a version of me before you and',
                'a version of me after. The after version',
                'is better in every way. That\'s because',
                'of you. All you.',
            ],
            [
                'Jillie,',
                '',
                'When I picture growing old, you\'re',
                'always there. Gray hair. Coffee on the',
                'porch. Still making me laugh. Still',
                'the most beautiful girl I\'ve ever seen.',
            ],
            [
                'Hey Jillie,',
                '',
                'I love you in the morning when you\'re',
                'half asleep. I love you at night when',
                'you can barely keep your eyes open.',
                'I love you in every single moment',
                'in between. Always.',
            ],
            [
                'Jillie,',
                '',
                'You didn\'t just give me love. You gave',
                'me a best friend. A teammate. Someone',
                'who actually gets me. I hit the jackpot',
                'and I know it.',
            ],
            [
                'Hey you,',
                ...
                'in my life, I\'d pick the one where I met',
                'you. And then every moment after that.',
            ],
            [
                'Jillie,',
                '',
                'I\'m writing this with a big stupid smile',
                'on my face because that\'s what happens',
            ...
            [
                'Hey Jillie,',
                '',
                'No matter where life takes us, no matter',
                'what changes, this won\'t. What I feel for',
                'you is permanent. It\'s carved in stone.',
            ...
            [
                'Jillie,',
                '',
                'You are the calm in every storm I\'ve',
                'ever been through. The steady hand.',
                'The soft voice. The safe place. I hope',
                'I give you even half of what you give me.',
            ],
            [
                'Hey,',
                '',
                'Sometimes I catch myself staring at you',
                'and I have to look away before you notice.',
                'But honestly? I hope you do notice.',
                'I want you to know.',
            ],
            [
                'Jillie,',
                '',
                'I love the little things. The way you',
                'scrunch your nose. The way you say my',
                'name. The way you hold my hand a little',
                'tighter when we\'re about to say goodbye.',
                '',
                'I notice all of it.',
            ],
        ];
